...
export async function getRecentActivityLogs(limit: number = 5): Promise<ActivityRecord[]> {
...
export async function getContractDetail(contractId: string): Promise<ContractDetailResponse | null> {
